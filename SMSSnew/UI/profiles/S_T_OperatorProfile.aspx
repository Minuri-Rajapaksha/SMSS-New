<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="S_T_OperatorProfile.aspx.cs"
    Inherits="SMSSnew.UI.profiles.S_T_OperatorProfile" %>
...
<body>
    <div class="container">
        ...
        <h4 class="text-info">
            My Profile - Substitute Teacher Operator</h4>
        <br />
        <table class="table container text-left">
            <tr>
                <td class="Colwidth">
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/IMAGES/operator.png" class="img-rounded imgsz" />
                </td>
                <td>
                </td>
            </tr>
