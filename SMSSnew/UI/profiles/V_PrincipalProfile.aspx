<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="V_PrincipalProfile.aspx.cs"
    Inherits="SMSSnew.UI.profiles.V_PrincipalProfile" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<link href="../../css/StyleSheet.css" rel="stylesheet" type="text/css" />
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>My Profile Vice Principal</title>
</head>
<body>
    <div class="container">
        ...
        <h4 class="text-info">
            My Profile - Vice Principal</h4>
        <br />
        <table class="table container text-left">
            <tr>
                <td class="Colwidth">
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/IMAGES/vprincipalF.png" class="img-rounded imgsz" />
                </td>
                <td>
                </td>
            </tr>
