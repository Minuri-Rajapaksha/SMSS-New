<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeacherProfile.aspx.cs"
    Inherits="SMSSnew.UI.profiles.TeacherProfile" %>
...
<body>
    <div class="container">
        ...
        <h4 class="text-info">
            My Profile - Teacher</h4>
        <br />
        <table class="table container text-left">
            <tr>
                <td class="Colwidth">
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/IMAGES/teacherF.png" class="img-rounded imgsz" />
                </td>
                <td>
                </td>
            </tr>
